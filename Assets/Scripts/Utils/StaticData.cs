...
public static class StaticData
{
    ...
    public static readonly Dictionary<int, BuildingStats> BDict = new Dictionary<int, BuildingStats>()
    {
        ...
        {121, new BuildingStats("Pasture", new Vector2Int(4,4), false, 100, new Res(12,0,250,0,0), new Res(0,60,0,0,0))},
        {122, new BuildingStats("Lumber Mill", new Vector2Int(3,2), true, 100, new Res(12,0,150,150,0), new Res(0,0,40,0,0), 0, LumberMill_drAdjDict)},
        {123, new BuildingStats("Forge", new Vector2Int(2,3), false, 100, new Res(12,0,100,200,0), new Res(0,0,0,40,0), 0, Forge_drAdjDict)},
        {130, new BuildingStats("Production Center lv3", new Vector2Int(3,3), false, 100, new Res(40,800,800,800,0), Res.zero)},
        {131, new BuildingStats("Diary Shop", new Vector2Int(2,1), false, 100, new Res(25,0,150,400,0), Res.zero, 0, DiaryShop_drAdjDict)},
        {132, new BuildingStats("Assembly Plant", new Vector2Int(3,4), false, 100, new Res(40,0,1200,1000,0), new Res(0,0,150,150,0), 0, AssemblyPlant_drAdjDict)},

        {200, new BuildingStats("Military Center lv0", new Vector2Int(3,3), false, 100, new Res(8,40,100,100,0), Res.zero)},
        {201, new BuildingStats("Barracks", new Vector2Int(1,2), false, 100, new Res(2,0,40,10,0), Res.zero, 5)},
        {210, new BuildingStats("Military Center lv1", new Vector2Int(3,3), false, 100, new Res(12,80,150,150,0), Res.zero)},
        {211, new BuildingStats("Blacksmith lv0", new Vector2Int(2,1), false, 100, new Res(3,0,200,100,0), Res.zero, 8)},
        {212, new BuildingStats("Blacksmith lv1", new Vector2Int(2,1), false, 100, new Res(10,0,200,300,0), Res.zero, 16)},
        {213, new BuildingStats("Stable", new Vector2Int(2,2), false, 100, new Res(5,50,100,15,0), Res.zero, 6, null)},
        {220, new BuildingStats("Military Center lv2", new Vector2Int(3,3), false, 100, new Res(20,200,400,400,0), Res.zero)},
        {221, new BuildingStats("Blacksmith lv2", new Vector2Int(2,1), false, 100, new Res(20,0,800,500,0), Res.zero, 32)},
        {222, new BuildingStats("Armoury", new Vector2Int(2,2), false, 100, new Res(10,0,250,350,0), Res.zero, 15, null, Armoury_capAdjDict)},
        {230, new BuildingStats("Military Center lv3", new Vector2Int(3,3), false, 100, new Res(40,500,1200,1200,0), Res.zero)},
        {231, new BuildingStats("Blacksmith lv3", new Vector2Int(2,1), false, 100, new Res(30,0,1000,1400,0), Res.zero, 64)},
        {232, new BuildingStats("Jousting ground", new Vector2Int(2,1), false, 100, new Res(20,200,650,300,0), Res.zero, 35)},
    };
